 ...
 * Signature: ()V
 */
JNIEXPORT void JNICALL Java_com_1auto_1pay_auto_1pay_1native_deleteObject
  (JNIEnv *, jobject);
 ...
 * Signature: (I)I
 */
JNIEXPORT jint JNICALL Java_com_1auto_1pay_auto_1pay_1native_showWidget
  (JNIEnv *, jobject, jint);
 ...
 * Signature: (I)I
 */
JNIEXPORT jint JNICALL Java_com_1auto_1pay_auto_1pay_1native_shutDown
  (JNIEnv *, jobject, jint);
